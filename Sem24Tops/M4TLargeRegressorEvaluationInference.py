...
class TransformerEvaluation():
    ...
    def compute_metrics(self, y_pred_scaled, y_true_scaled):
        ...
        print(f"Invariant Mass RMSE after unbiasing: {invariant_mass_rmse_biased:.2f} GeV")
        print(f"HT RMSE after unbiasing: {ht_rmse_biased:.2f} GeV")
        print(f"Invariant Mass RMSE: {invariant_mass_rmse:.2f} GeV")
        print(f"HT RMSE: {ht_rmse:.2f} GeV")
