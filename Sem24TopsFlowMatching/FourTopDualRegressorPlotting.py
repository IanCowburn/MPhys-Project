...
class TransformerPlotting:
    ...
    def plot_loss_curves(self, outpath='Transformer_kl_div_training_validation_loss.png'):
    ...
    def plot_all(self):
        ...
        with plt.rc_context({'font.size': 16}):
            ...
            fig.savefig('Transformer_kl_div_mass_ht_error_distribution.png', dpi=300, bbox_inches='tight')
            plt.show()
            plt.close(fig)
        ...
        with plt.rc_context({'font.size': 16}):
            ...
            fig.savefig('Transformer_kl_div_mass_ht_distribution.png', dpi=300, bbox_inches='tight')
            plt.show()
            plt.close(fig)
        ...
        with plt.rc_context({'font.size': 20}):
            ...
            fig.savefig('Transformer_kl_div_mass_ht_2d_histogram.png', dpi=300, bbox_inches='tight')
            plt.show()
            plt.close(fig)
        ...
        with plt.rc_context({'font.size': 16}):
            ...
            fig.savefig('Transformer_kl_div_mass_ht_binned_plot_percent.png', dpi=300, bbox_inches='tight')
            plt.show()
            plt.close(fig)
