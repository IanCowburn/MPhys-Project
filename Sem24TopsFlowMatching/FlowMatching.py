...
def kl_divergence_from_samples(true_samples, pred_samples, bins=100, range_min=None, range_max=None):
...
kl_mass = kl_divergence_from_samples(y_true_mass, y_pred_mass, bins=100, range_min=0, range_max=6e3)
kl_ht = kl_divergence_from_samples(y_true_ht, y_pred_ht, bins=100, range_min=0, range_max=4e3)
